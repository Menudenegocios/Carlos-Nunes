    ...
    <div className="max-w-7xl mx-auto space-y-24 pb-32 pt-8 px-6">
      ...
      <section className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-gray-900 tracking-tighter leading-none max-w-4xl mx-auto">
          Ninguém cresce <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-indigo-600">sozinho.</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {MOCK_PARTNERS.map((partner, i) => (
          <div key={i} className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-lg flex flex-col items-center text-center space-y-6 hover:shadow-2xl hover:-translate-y-2 transition-all">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest mt-1">{partner.role}</p>
            </div>
          </div>
        ))}
      </div>
