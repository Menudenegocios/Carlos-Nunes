    ...
    <div className="max-w-7xl mx-auto space-y-24 pb-32 pt-8 px-6">
      ...
      <section className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-gray-900 dark:text-white tracking-tighter leading-none max-w-4xl mx-auto">
          Conecte-se e <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-brand-primary dark:to-brand-accent">Aprenda ao Vivo.</span>
        </h1>
      ...
      <section className="space-y-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-100 dark:border-zinc-800 pb-10">
            ...
            <div className="flex gap-2">
                ...
                <button className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 text-gray-500 dark:text-zinc-400 rounded-xl font-bold text-xs tracking-tight hover:bg-gray-50 dark:hover:bg-zinc-700">Evento Online</button>
                <button className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 text-gray-500 dark:text-zinc-400 rounded-xl font-bold text-xs tracking-tight hover:bg-gray-50 dark:hover:bg-zinc-700">Evento Presencial</button>
            </div>
        </div>
