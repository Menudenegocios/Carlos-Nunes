            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                 <h1 className="text-4xl md:text-5xl font-black tracking-tight leading-none mb-2">
                   <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] via-[#F67C01] to-[#9333EA] dark:from-brand-primary dark:to-brand-accent italic uppercase">Studio Menu Flow</span>
                 </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
               <div className="lg:col-span-5 bg-white dark:bg-zinc-900 rounded-[3rem] p-10 border border-gray-100 dark:border-zinc-800 shadow-xl space-y-8 animate-fade-in">
                  <div className="flex items-center gap-3 mb-4">
                     <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-950/30 rounded-xl flex items-center justify-center text-indigo-600"><Type className="w-6 h-6" /></div>
                     <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight italic">Copywriter Pro</h3>
                  </div>
                  ...
                  <form onSubmit={handleGenerateText} className="space-y-6">
                     <div>
                        ...
                        <input required type="text" className="w-full bg-gray-50 dark:bg-zinc-800 border-none rounded-2xl p-5 font-bold focus:ring-4 focus:ring-brand-primary/10 transition-all dark:text-white" placeholder="Ex: Hamburgueria Artesanal" value={businessType} onChange={e => setBusinessType(e.target.value)} />
                     </div>
                     <div>
                  ...
                  {textResult ? (
                    <div className="bg-white dark:bg-zinc-900 rounded-[3rem] p-10 border border-gray-100 dark:border-zinc-800 shadow-xl min-h-[500px] flex flex-col animate-fade-in relative overflow-hidden">
                        <div className="flex justify-between items-center mb-10 relative z-10">
                           <h3 className="text-2xl font-black text-gray-900 dark:text-white italic">Resultado IA</h3>
                        ...
                        <div className="flex-1 prose prose-slate dark:prose-invert max-w-none relative z-10 font-medium text-lg leading-relaxed bg-gray-50/50 dark:bg-black/20 p-8 rounded-[2.5rem]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                <div className="lg:col-span-5 bg-white dark:bg-zinc-900 rounded-[3rem] p-10 border border-gray-100 dark:border-zinc-800 shadow-xl space-y-8 animate-fade-in">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight italic">Menu Flow Image</h3>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[
                                    ...
                                    <button key={ratio.id} type="button" onClick={() => setAspectRatio(ratio.id as AspectRatio)} className={`p-4 rounded-2xl border text-[9px] font-black uppercase tracking-tighter transition-all flex flex-col items-center gap-2 ${aspectRatio === ratio.id ? 'bg-brand-primary border-brand-primary text-white shadow-lg' : 'bg-white dark:bg-zinc-800 border-gray-100 dark:border-zinc-700 text-gray-400'}`}>
                    ...
                    {imageResult ? (
                        <div className="bg-white dark:bg-zinc-900 rounded-[3rem] p-10 border border-gray-100 dark:border-zinc-800 shadow-xl animate-fade-in space-y-8">
                            <div className="flex justify-between items-center">
                                <h3 className="text-2xl font-black text-gray-900 dark:text-white uppercase italic">Arte Final</h3>
                                <div className="flex gap-2">
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-[3rem] border border-gray-100 dark:border-zinc-800 flex flex-col items-center justify-center p-20 text-center min-h-[600px] space-y-8">
                            <div className="relative">
                                ...
                                <div className="w-32 h-32 bg-white dark:bg-zinc-800 rounded-full flex items-center justify-center text-brand-primary shadow-xl relative z-10 border border-orange-100">
                                    <RefreshCw className="w-12 h-12 animate-spin" />
                                </div>
                            </div>
                            <div>
                                <h4 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tight">O Menu Flow está pincelando sua arte...</h4>
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-[3rem] border-4 border-dashed border-gray-100 dark:border-zinc-800 flex flex-col items-center justify-center p-20 text-center min-h-[600px]">
                            ...
                            <p className="text-gray-400 dark:text-zinc-700 max-w-xs mt-4 font-medium uppercase tracking-tighter">Gere fotos de produtos, conceitos visuais ou posts para Instagram em segundos.</p>
                        </div>
                    )}
                </div>
            </div>
