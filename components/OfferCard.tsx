...
export const OfferCard: React.FC<OfferCardProps> = ({ offer, onClick }) => {
  ...
  const embedUrl = offer.video_url ? getEmbedUrl(offer.video_url) : null;
    ...
    >
      ...
      <div className="relative h-[280px] w-full overflow-hidden bg-gray-50">
        {showVideo && embedUrl ? (
          ...
          <img 
            src={offer.image_url || `https://images.unsplash.com/photo-1556740738-b6a63e27c4df?auto=format&fit=crop&q=80&w=800`} 
            alt={offer.title} 
      ...
      <div className="p-8 flex-1 flex flex-col pt-10">
        ...
        <div className="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
             {offer.social_links?.whatsapp && (
               <a 
                href={`https://wa.me/${offer.social_links.whatsapp}`} 
                target="_blank" 
